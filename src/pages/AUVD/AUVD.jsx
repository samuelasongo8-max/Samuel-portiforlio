...
export default function AUVD() {
  ...
  useEffect(() => {
    const backgroundInterval = setInterval(() => {
      setHeroBackground((currentBackground) => (currentBackground === 0 ? 1 : 0));
    }, 10000);
  ...
  return (
    <div className="auvd-page">
      <link rel="preload" as="image" href="/AUVD student1.webp" type="image/webp" />
      <link rel="preload" as="image" href="/AUVD student2.webp" type="image/webp" />
      <section className="auvd-hero">
        <div
          className={`auvd-hero-background auvd-hero-background-one${heroBackground === 0 ? ' auvd-hero-background-active' : ''}`}
          aria-hidden="true"
        />
        <div
          className={`auvd-hero-background auvd-hero-background-two${heroBackground === 1 ? ' auvd-hero-background-active' : ''}`}
          aria-hidden="true"
        />
